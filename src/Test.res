...
let make = () =>
  <div className={style(list{background(hex("f5f5f5"))})}>
    <Section name="angles">
      ...
      <div
        className={style(\"@"(redBox, list{transform(rotate(rad(3.1415)))}))}
      />
      <div
        className={style(\"@"(redBox, list{transform(rotate(grad(50.)))}))}
      />
      <div
        className={style(\"@"(redBox, list{transform(rotate(turn(1. /. 3.)))}))}
      />
    </Section>
    <Section name="colors">
      ...
      <div
        className={style(
          \"@"(redBox, list{background(rgba(255, 0, 0, #num(0.5)))}),
        )}
      />
      <div
        className={style(
          \"@"(redBox, list{background(hsl(deg(255.), pct(100.), pct(50.)))}),
        )}
      />
      <div
        className={style(
          \"@"(
            redBox,
            list{background(hsla(deg(255.), pct(100.), pct(50.), #num(0.5)))},
          ),
        )}
      />
      ...
      <div
        className={style(
          \"@"(redBox, list{background(currentColor), color(blue)}),
        )}
      />
    </Section>
    <Section name="Named colors">
      {React.array(
        [
          ...
          <div className={style(list{background(c), ...miniBox})} />
        ),
      )}
    </Section>
      ...
      <div
        className={style(
          \"@"(
            ...
            list{
              background(
                linearGradient(deg(45.), list{(zero, red), (pct(100.), blue)}),
              ),
            },
          ),
        )}
      ...
      <div
        className={style(
          \"@"(
            redBox,
            list{
              background(radialGradient(list{(zero, red), (pct(100.), blue)})),
            },
          ),
        )}
      />
      <div
        className={style(
          \"@"(
            ...
            list{
              background(
                repeatingRadialGradient(list{(zero, red), (pct(10.), blue)}),
              ),
            },
          ),
        )}
    ...
    <Section name="position">
      ...
      <div
        className={style(
          \"@"(redBox, list{position(fixed), bottom(px(10)), right(px(10))}),
        )}
      />
    ...
    <Section name="Padding & Margin">
      <div
        className={style(\"@"(redBox, list{padding(px(10)), margin(px(10))}))}
      />
      <div
        className={style(
          \"@"(
      ...
      <div
        className={style(
          \"@"(
            redBox,
            list{padding2(~v=px(10), ~h=px(20)), margin2(~v=px(10), ~h=px(20))},
          ),
        )}
      />
      <div
    ...
    <Section name="grid">
      ...
      <div
        ...
        <div className={style(list{background(red)})}>
      ...
      <div className={style(list{display(#grid), gridAutoColumns(100->px)})}>
        ...
        <div className={style(list{background(blue)})}>
          {"100px"->React.string}
        </div>
      </div>
    </Section>
    <Section name="flexbox">
      <div
        ...
        <div
          ...
          <div
            className={style(
              \"@"(
                redBox,
                list{order(1), flexGrow(1.), flexShrink(1.), flexBasis(auto)},
              ),
            )}
          />
          ...
          <div
            className={style(
              \"@"(
                redBox,
                list{order(1), flex3(~grow=1.5, ~shrink=0.8, ~basis=100->px)},
              ),
            )}
          />
        ...
        <div
          ...
          <div className={style(redBox)} />
          <div
            className={style(\"@"(redBox, list{height(px(50)), width(px(50))}))}
          />
          <div className={style(redBox)} />
        </div>
        <div
    ...
    <Section name="float">
      <div
        className={style(\"@"(redBox, list{Css.float(#left), clear(#right)}))}
      />
      <div
        className={style(\"@"(redBox, list{Css.float(#right), clear(#left)}))}
      />
      <div
        className={style(\"@"(redBox, list{Css.float(none), clear(both)}))}
      />
    </Section>
    ...
    <Section name="border">
      <div
        className={style(
          \"@"(
            redBox,
            list{border(px(5), solid, blue), borderRadius(px(1000))},
          ),
        )}
      />
      <div
      ...
      <div
        className={style(
          \"@"(
            redBox,
            list{borderWidth(px(5)), borderStyle(solid), borderColor(blue)},
          ),
        )}
      />
      <div
    ...
    <Section name="cursor">
      <div className={style(\"@"(redBox, list{cursor(#auto)}))}>
        {"auto"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#default)}))}>
        {"default"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#none)}))}>
        {"none"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#contextMenu)}))}>
        {"context menu"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#help)}))}>
        {"help"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#pointer)}))}>
        {"pointer"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#progress)}))}>
        {"progress"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#wait)}))}>
        {"wait"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#cell)}))}>
        {"cell"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#crosshair)}))}>
        {"crosshair"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#text)}))}>
        {"text"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#verticalText)}))}>
        {"vert text"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#alias)}))}>
        {"alias"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#copy)}))}>
        {"copy"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#move)}))}>
        {"move"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#noDrop)}))}>
        {"no drop"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#notAllowed)}))}>
        {"not allowed"->React.string}
      </div>
      <div className={style(\"@"(redBox, list{cursor(#grab)}))}>
        {"grab"->React.string}
      </div>
      ...
      <div className={style(\"@"(redBox, list{cursor(#zoomIn)}))}>
    ...
    <Section name="outline">
      <div
        className={style(\"@"(redBox, list{outline(px(5), #double, green)}))}
      />
      <div
        className={style(
          \"@"(
      ...
      />
      <div
        className={style(\"@"(redBox, list{outline(px(5), #double, red)}))}
      />
    ...
    <Section name="transform">
      ...
      <div
        className={style(
          \"@"(redBox, list{perspective(px(500)), transform(rotate(deg(10.)))}),
        )}
      />
      <div
        className={style(
    ...
    <Section name="text">
      ...
      <h2 className={style(list{width(pct(100.))})}>
      ...
      <span className={style(list{fontWeight(light), ...fontItem})}>
        {"light"->React.string}
      </span>
      ...
      <span className={style(list{fontWeight(bold), ...fontItem})}>
        {"bold"->React.string}
      </span>
    ...
    <Section name="filter">
      <div
        className={style(\"@"(redBox, list{filter(list{#blur(#px(10))})}))}
      />
      <div
        className={style(\"@"(redBox, list{filter(list{#brightness(50.)})}))}
      />
      <div
        className={style(\"@"(redBox, list{filter(list{#contrast(50.)})}))}
      />
      <div
        className={style(
          \"@"(
      ...
      />
      <div
        className={style(\"@"(redBox, list{filter(list{#grayscale(50.)})}))}
      />
      <div
        className={style(
          \"@"(redBox, list{filter(list{#hueRotate(#deg(180.))})}),
        )}
      />
      <div className={style(\"@"(redBox, list{filter(list{#invert(50.)})}))} />
      <div className={style(\"@"(redBox, list{filter(list{#opacity(50.)})}))} />
      <div
        className={style(\"@"(redBox, list{filter(list{#saturate(50.)})}))}
      />
    ...
    <Section name="object-fit">
      <img
        className={style(\"@"(redBox, list{objectFit(#fill)}))}
        src="./img-29.jpg"
      />
      <img
        className={style(\"@"(redBox, list{objectFit(#contain)}))}
        src="./img-29.jpg"
      />
      <img
        className={style(\"@"(redBox, list{objectFit(#cover)}))}
        src="./img-29.jpg"
      />
      <img
        className={style(\"@"(redBox, list{objectFit(#none)}))}
        src="./img-29.jpg"
      />
      <img
        className={style(\"@"(redBox, list{objectFit(#scaleDown)}))}
        src="./img-29.jpg"
      />
      <img
        className={style(\"@"(redBox, list{objectFit(#inherit_)}))}
        src="./img-29.jpg"
      />
      <img
        className={style(\"@"(redBox, list{objectFit(#initial)}))}
        src="./img-29.jpg"
      />
      <img
        className={style(\"@"(redBox, list{objectFit(#unset)}))}
        src="./img-29.jpg"
      />
    </Section>
  </div>
